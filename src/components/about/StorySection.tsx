        ...
        <div className="grid items-start gap-12 lg:grid-cols-[1.2fr_0.8fr] lg:gap-20">
          ...
          <FadeIn delay={0.3} className="hidden lg:block">
            <div className="relative">
              ...
              <div className="absolute -top-4 -right-4 h-full w-full rounded-sm border-2 border-champagne/15" />
              {/* Magenta accent */}
              <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-sm bg-magenta/10" />
            </div>
          </FadeIn>
        </div>
      </Container>
